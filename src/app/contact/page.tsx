        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {contactLinks.map((link) => (
            <a
              ...
              className="flex items-center gap-4 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hover:border-primary-500 dark:hover:border-primary-500 transition-all duration-300 group"
            >
