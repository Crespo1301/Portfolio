...
// Reusable icon components to keep other files clean
// Usage: import { GithubIcon, ExternalLinkIcon } from "@/components/Icons";
...
export function ImagePlaceholderIcon({ className = "w-16 h-16" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
