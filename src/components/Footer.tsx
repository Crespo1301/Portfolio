export default function Footer() {
  const socialLinks = [
    { name: "GitHub", url: "https://github.com/Crespo1301", icon: "github" },
    { name: "LinkedIn", url: "https://www.linkedin.com/in/carlos-crespo-46608014a/", icon: "linkedin" },
    { name: "Email", url: "mailto:Crespo1301@gmail.com", icon: "email" },
  ];
